...
public class Tools {
    ...
    public static <E> void showSpinnerDialog(
            Activity activity,
            final ArrayList<E> lstData,
            final String title,
            final SpinnerDialog.OnSpinerItemClick<E> onSpinerItemClick) {
        SpinnerDialogCustomV2<E> spinnerDialog = new SpinnerDialogCustomV2<E>(activity, lstData, title,
                "Đóng");
        spinnerDialog.bindOnSpinerListener(onSpinerItemClick);
